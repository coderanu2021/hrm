...
<main class="page-content">
  <div class="page-header">
    <div>
      ...
      <p class="page-subtitle">Manage multi-directional feedback cycles</p>
    </div>
  </div>
  ...
  <div class="page-body">
      ...
      <div class="card" style="padding:0;">
        <div style="padding:20px 24px; border-bottom:1px solid var(--border); display:flex; justify-content:space-between; align-items:center;">
            ...
            <a href="{{ route('admin.addFeedback') }}" class="btn-primary" style="border-radius:8px; text-decoration:none; display:inline-flex; align-items:center;">Add New</a>
        </div>
        <div style="padding:0;">

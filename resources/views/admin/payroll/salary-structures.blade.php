...
<main class="page-content">
  <div class="page-header">
    <div>
      ...
      <p class="page-subtitle">Configure compensation bands and structures</p>
    </div>
  </div>
  ...
  <div class="page-body">
      ...
      <div class="header-actions" style="margin-bottom: 24px; display: flex; justify-content: space-between;">
        ...
        <a href="{{ route('admin.addSalaryStructures') }}" class="btn-primary" style="border-radius:8px; text-decoration:none; display:inline-flex; align-items:center;">
        ...
        <div style="overflow-x: auto;">
          <table style="width:100%; border-collapse: collapse; text-align: left;">
            <thead style="background: var(--bg-main); border-bottom: 1px solid var(--border);">
              <tr>
                <th style="padding: 16px 24px; font-weight:600; color:var(--text-muted); font-size:12px; text-transform:uppercase; letter-spacing:0.5px; text-align: left;">Band Name</th>
                <th style="padding: 16px 24px; font-weight:600; color:var(--text-muted); font-size:12px; text-transform:uppercase; letter-spacing:0.5px; text-align: left;">Min Salary</th>
                <th style="padding: 16px 24px; font-weight:600; color:var(--text-muted); font-size:12px; text-transform:uppercase; letter-spacing:0.5px; text-align: left;">Max Salary</th>
            ...
            <tbody>
              <tr style="border-bottom: 1px solid var(--border);">
                ...
                <td style="padding: 16px 24px; color:var(--text-muted); font-size:14px;">Sample Min Salary</td>
                <td style="padding: 16px 24px; color:var(--text-muted); font-size:14px;">Sample Max Salary</td>

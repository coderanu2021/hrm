...
<main class="page-content">
  <div class="page-header">
    <div>
      <h1 class="page-title">Comp-Off</h1>
      <p class="page-subtitle">Manage compensatory off balances</p>
    </div>
  </div>
  ...
  <div class="page-body">
      ...
      <div class="header-actions" style="margin-bottom: 24px; display: flex; justify-content: space-between;">
        ...
        <a href="{{ route('admin.addCompOff') }}" class="btn-primary" style="border-radius:8px; text-decoration:none; display:inline-flex; align-items:center;">
        ...
        <div style="overflow-x: auto;">
          <table style="width:100%; border-collapse: collapse; text-align: left;">
            <thead style="background: var(--bg-main); border-bottom: 1px solid var(--border);">
              <tr>
                <th style="padding: 16px 24px; font-weight:600; color:var(--text-muted); font-size:12px; text-transform:uppercase; letter-spacing:0.5px; text-align: left;">Employee</th>
                <th style="padding: 16px 24px; font-weight:600; color:var(--text-muted); font-size:12px; text-transform:uppercase; letter-spacing:0.5px; text-align: left;">Earned Hours</th>
                <th style="padding: 16px 24px; font-weight:600; color:var(--text-muted); font-size:12px; text-transform:uppercase; letter-spacing:0.5px; text-align: left;">Used Hours</th>
                <th style="padding: 16px 24px; font-weight:600; color:var(--text-muted); font-size:12px; text-transform:uppercase; letter-spacing:0.5px; text-align: left;">Balance</th>
            ...
            <tbody>
              <tr style="border-bottom: 1px solid var(--border);">
                ...
                <td style="padding: 16px 24px; color:var(--text-muted); font-size:14px;">Sample Earned Hours</td>
                <td style="padding: 16px 24px; color:var(--text-muted); font-size:14px;">Sample Used Hours</td>
                <td style="padding: 16px 24px; color:var(--text-muted); font-size:14px;">Sample Balance</td>

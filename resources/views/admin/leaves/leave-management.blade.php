...
<main class="page-content">
  ...
  <div class="page-body">
      ...
      <div class="header-actions" style="margin-bottom: 24px; display: flex; justify-content: space-between;">
        ...
        <a href="{{ route('admin.addLeaveManagement') }}" class="btn-primary" style="border-radius:8px; text-decoration:none; display:inline-flex; align-items:center;">
          ...
          <table style="width:100%; border-collapse: collapse; text-align: left;">
            <thead style="background: var(--bg-main); border-bottom: 1px solid var(--border);">
              <tr>
                ...
                <th style="padding: 16px 24px; font-weight:600; color:var(--text-muted); font-size:12px; text-transform:uppercase; letter-spacing:0.5px; text-align: left;">Leave Type</th>
                <th style="padding: 16px 24px; font-weight:600; color:var(--text-muted); font-size:12px; text-transform:uppercase; letter-spacing:0.5px; text-align: left;">Duration</th>
                <th style="padding: 16px 24px; font-weight:600; color:var(--text-muted); font-size:12px; text-transform:uppercase; letter-spacing:0.5px; text-align: left;">Reason</th>
            ...
            <tbody>
              <tr style="border-bottom: 1px solid var(--border);">
                ...
                <td style="padding: 16px 24px; color:var(--text-muted); font-size:14px;">Sample Leave Type</td>
                <td style="padding: 16px 24px; color:var(--text-muted); font-size:14px;">Sample Duration</td>
                <td style="padding: 16px 24px; color:var(--text-muted); font-size:14px;">Sample Reason</td>

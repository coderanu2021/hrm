...
<body>
  ...
  <aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
      ...
      <a href="{{ route('admin.onboarding') }}" class="nav-item" data-page="onboarding">
      ...
      <a href="{{ route('admin.jobPostings') }}" class="nav-item" data-page="job-postings">
      ...
      <a href="{{ route('admin.candidates') }}" class="nav-item" data-page="candidates">
      ...
      <a href="{{ route('admin.attendanceLog') }}" class="nav-item" data-page="attendance-log">
      ...
      <a href="{{ route('admin.shifts') }}" class="nav-item" data-page="shifts">
      ...
      <a href="{{ route('admin.corrections') }}" class="nav-item" data-page="corrections">
      ...
      <a href="{{ route('admin.bulkImport') }}" class="nav-item" data-page="bulk-import">
      ...
      <a href="{{ route('admin.geofencing') }}" class="nav-item" data-page="geofencing">
      ...
      <a href="{{ route('admin.leaveManagement') }}" class="nav-item" data-page="leave-management">
      ...
      <a href="{{ route('admin.leavePolicies') }}" class="nav-item" data-page="leave-policies">
      ...
      <a href="{{ route('admin.leaveCalendar') }}" class="nav-item" data-page="leave-calendar">
      ...
      <a href="{{ route('admin.holidayCalendar') }}" class="nav-item" data-page="holiday-calendar">
      ...
      <a href="{{ route('admin.compOff') }}" class="nav-item" data-page="comp-off">
      ...
      <a href="{{ route('admin.okrs') }}" class="nav-item" data-page="okrs">
      ...
      <a href="{{ route('admin.feedback') }}" class="nav-item" data-page="feedback">
      ...
      <a href="{{ route('admin.reviewCycles') }}" class="nav-item" data-page="review-cycles">
      ...
      <a href="{{ route('admin.pips') }}" class="nav-item" data-page="pips">
      ...
      <a href="{{ route('admin.courseCatalog') }}" class="nav-item" data-page="course-catalog">
      ...
      <a href="{{ route('admin.salaryStructures') }}" class="nav-item" data-page="salary-structures">
      ...
      <a href="{{ route('admin.payrollRun') }}" class="nav-item" data-page="payroll-run">
        <svg class="nav-icon" viewBox="0 0 24 24" fill="none"><path d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/></svg>
        Payroll Run
      </a>
      ...
      <a href="{{ route('admin.analytics') }}" class="nav-item" data-page="analytics">
      ...
      <a href="{{ route('admin.customReports') }}" class="nav-item" data-page="custom-reports">
      ...
      <a href="{{ route('admin.adminSettings') }}" class="nav-item" data-page="admin-settings">
      ...
      <a href="{{ route('admin.roleManagement') }}" class="nav-item" data-page="role-management">
      ...
      <a href="{{ route('admin.auditLog') }}" class="nav-item" data-page="audit-log">
